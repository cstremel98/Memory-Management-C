...
```c
node_t* find_free_chunk(size_t size);                               // 20 points
void split_node(node_t* node, size_t size);                         // 25 points
node_t* get_header(void* ptr);                                      // 20 points
void coalesce_nodes(node_t* front, node_t* back);                   // 15 points

extern void* mem_alloc(size_t size);                                // 10 points
extern void mem_free(void *ptr);                                    // 10 points
```
